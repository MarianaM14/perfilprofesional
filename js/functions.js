...
//body - pantalla
document.write(name);
document.getElementById("text_one").innerHTML = "<h1>Mariana Muñoz</h1>";
document.getElementById("text_two").innerText = "<h1>Mariana Muñoz</h1>";
